...
namespace ZH.Code.IEX.V2.Helper
{
    public class IEXSigner
    {
        ...
        public IEXSigner(string host, string sk, string pk)
        {
            _host = host;
            _sk = sk;
            _pk = pk;
        ...
        public (string iexdate, string authorization_header) Sign(string method, string url, string queryString, string payload = "")
        {
            ...
            var authorization_header = $"IEX-HMAC-SHA256 Credential={_pk}/{credential_scope}, SignedHeaders=host;x-iex-date, Signature={signature}";
